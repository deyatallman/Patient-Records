...
/**
 * This class represents a unique UHealthID, which has a four letter prefix and
 * four number suffix, such as ABCD-0123
 *
 * @author Eric Heisler
 * @version May 5, 2023
 */
public class UHealthID {
	...
	public UHealthID(String uHID) {
		...
		if (isValid) {
			...
			this.suffix = "0000";
			System.err.println(
					"Patient ID \"" + uHID + "\" is not formatted correctly, initializing as " + toString() + ".");
		}
	}
	 ...
	 * @return true if the other object is a UHealthID type and is equal to this ID,
	 *         false otherwise
	 */
