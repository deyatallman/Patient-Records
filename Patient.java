...
/**
 * This class represents a UHealth patient who has a unique UHealthID and a
 * first and last name.
 *
...
public class Patient {
	 ...
	 * @return true if the other object is a Patient type and is equal to this
	 *         patient, false otherwise.
	 */
	public boolean equals(Object other) {
		if (!(other instanceof Patient))
			return false;
		Patient otherPatient = (Patient) other;
		if (this.uHealthID.equals(otherPatient.uHealthID))
			return true;
		return false;
	}
